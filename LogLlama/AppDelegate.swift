...
class AppDelegate: NSObject, NSApplicationDelegate {
  ...
  func applicationDidFinishLaunching(_ aNotification: Notification) {
    ...
    NotificationCenter.default.addObserver(
      self, selector: #selector(onTextChanged(_:)), name: .ScriptTextChanged, object: nil)
    NotificationCenter.default.addObserver(
      self, selector: #selector(onCanUndoUpdated(_:)), name: .CanUndoUpdated, object: nil)
  ...
  @IBAction func saveFile(_ sender: Any) {
    if !DocumentState.INSTANCE.isFileLoaded() {
      ...
      NotificationCenter.default.post(
        name: .SaveScriptFile, object: DocumentState.INSTANCE.getCurrentFile())
  ...
  func sendFontSizeUpdate() {
    NotificationCenter.default.post(
      name: .FontSizeUpdated, object: FontSizeUpdate(size: self.fontSize))
  }
